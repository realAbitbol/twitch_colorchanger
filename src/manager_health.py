"""Health monitoring logic extracted from `bot_manager.BotManager`.

Keeps reconnection and periodic health tasks isolated for clarity.
"""
...
class HealthMonitor:
    ...
    # --- internal helpers copied from manager (logic unchanged) ---
