"""Health checking helpers extracted from AsyncTwitchIRC."""
...
class IRCHealthMonitor:
    """Encapsulates health snapshot logic for an IRC connection host."""
    ...
    def get_health_snapshot(self) -> dict[str, Any]:
        ...
        if (
            host._join_grace_deadline  # pylint: disable=protected-access
            and current_time < host._join_grace_deadline  # pylint: disable=protected-access
