...
class TestStressConcurrent:
    ...
    async def test_concurrent_message_processing_stress(self):
        ...
        async def simulate_message_processing(user, channel, message):
            ...
            # Simulate processing time - mock sleep to avoid delays
            return True
    ...
    async def test_multiple_bot_concurrent_operations(self):
        ...
        with (
            ...
            assert start_calls + stop_calls == 3
        ...
        with (
            ...
            for i, bot in enumerate(mock_bots):
                assert bot.handle_message.call_count == 5
    ...
    async def test_resource_usage_under_concurrent_load(self):
        ...
        with patch('src.utils.resource_monitor.ResourceMonitor.start_monitoring', AsyncMock()):
            ...
            try:
                ...
                load_duration = 0.5  # 0.5 seconds of concurrent load
                concurrent_tasks = 1
                ...
                max_acceptable_growth = 8.0  # Allow 700% growth for mock
