"""Join workflow manager for AsyncTwitchIRC (extracted from async_irc)."""
...
class IRCJoinManager:
    """Handles channel join operations & confirmation message processing."""
    ...
    async def _wait_for_join_confirmation(self, channel: str) -> bool:
        ...
        while time.time() - start_time < ASYNC_IRC_JOIN_TIMEOUT:
            try:
                ...
                # Reuse dispatcher to process lines
                message_buffer = await self.client.dispatcher.process_incoming_data(  # type: ignore[attr-defined] # noqa: SLF001
                ...
                continue  # Expected short timeout
    ...
    async def join_channel(self, channel: str) -> bool:
        """Public join with retry/timeout logic (moved from client)."""
        channel = channel.lower()
